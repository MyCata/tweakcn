		...
		<div className="container mx-auto px-4 py-12 md:px-6 md:py-20 lg:max-w-4xl">
			...
			<section className="mb-8 space-y-4">
				...
				<ul className="text-muted-foreground list-inside list-disc space-y-2 pl-4">
					...
					<li>
						<strong>Restriction:</strong> You can ask us to restrict the use of
						your data under certain conditions.
					</li>
					<li>
						<strong>Data Portability:</strong> You have the right to transfer
						your personal data to another service provider, if applicable.
					</li>
					<li>
						<strong>Withdrawal of Consent:</strong> You can withdraw your
