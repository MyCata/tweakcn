...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://tweakcn.devosurf.dev/figma",
    siteName: "tweakcn",
    images: [
      {
        url: "https://tweakcn.devosurf.dev/figma-onboarding/shadcraft-preview.jpg",
        width: 1200,
        height: 630,
  ...
  twitter: {
    ...
    images: ["https://tweakcn.devosurf.dev/figma-onboarding/shadcraft-preview.jpg"],
  },
  robots: "index, follow",
  alternates: {
    canonical: "https://tweakcn.devosurf.dev/figma",
  },
};
